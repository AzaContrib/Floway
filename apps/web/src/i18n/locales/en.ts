    ...
    dashboard: {
      ...
      apiKeys: {
        ...
        configuration: {
          ...
          flowayCliHint: 'The installer downloads the floway CLI and configures every agent above in one pass; manage it later with <path>floway update</path> and <path>floway uninstall</path>.',
        },
        agentSetup: {
